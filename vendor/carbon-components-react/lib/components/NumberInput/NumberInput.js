...
function (_Component) {
  ...
  _createClass(NumberInput, [{
    ...
    value: function render() {
      ...
      var numberInputClasses = (0, _classnames.default)("".concat(prefix, "--number"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--number--light"), light), _defineProperty(_classNames, "".concat(prefix, "--number--helpertext"), helperText), _defineProperty(_classNames, "".concat(prefix, "--number--nolabel"), hideLabel), _classNames));
      var props = {
        disabled: disabled,
        id: id,
        max: max,
      ...
      return _react.default.createElement("div", {
        ...
        viewBox: "0 0 10 5",
        description: this.props.iconDescription
      }))), labelText, _react.default.createElement("input", _extends({
        type: "number",
        pattern: "[0-9]*"
      }, other, props, {
