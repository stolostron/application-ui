...
export const getNumDeployables = data => {
  if (
    data &&
    data.custom &&
    data.custom.deployables &&
    data.custom.deployables instanceof Array
  ) {
    return data.custom.deployables.length
  } else {
    return '-'
  }
}
...
export const getNumFailedDeployments = data => {
  if (
    data &&
    data.custom &&
    data.custom.failedDeployments &&
    data.custom.failedDeployments instanceof Array
  ) {
    return data.custom.failedDeployments.filter(obj => obj.status === 'Failed')
      .length
  } else {
    return '-'
  }
