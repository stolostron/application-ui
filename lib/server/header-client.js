...
exports.getHeader = (req, cb) => {
  const options = httpUtil.getOptions(req, `${config.get('cfcRouterUrl')}${PLATFORM_HEADER_CONTEXT_PATH}/api/v1/header?serviceId=mcm-ui&dev=${process.env.NODE_ENV === 'development'}`)
