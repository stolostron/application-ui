...
export const deleteCompliance = gql`
  mutation deleteCompliance($name: String!, $namespace: String!, $resources: JSON) {
    deleteCompliance(name: $name, namespace: $namespace, resources: $resources)
  }
`
...
export const HCMRelease = gql`
  query getRelease($name: String!, $namespace: String!, $clusterName: String) {
    items: release(name: $name, namespace: $namespace, clusterName: $clusterName) {
      ChartName: chartName
...
export const HCMPolicy = gql`
  query getPolicies($name: String!, $namespace: String, $clusterName: String) {
    policies: policies(name: $name, namespace: $namespace, clusterName: $clusterName) {
      cluster
      metadata {
        name
        namespace
