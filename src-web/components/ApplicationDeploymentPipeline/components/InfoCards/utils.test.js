...
describe('getPolicyViolationData', () => {
    ...
    it('check application list', () => {
        const policyViolationData = getPolicyViolationData(sampleApplicationData, 'guestbook2-gbapp', 'guestbook2')

        console.log("policyViolationData", policyViolationData)
                    ...
                    items: [
                        {
                            ...
                            cluster: 'local-cluster',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/staging/deployables/staging-gbchn-frontend',
                            kind: 'deployable',
                            _rbac: 'staging_app.ibm.com_deployables',
                            _uid: 'local-cluster/cffebce2-fa65-11e9-80a3-00163e01bcb4',
                            _clusterNamespace: 'local-cluster',
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; component=main; heritage=Tiller; package=guestbook; release=staging'
                        },
                        {
                            apigroup: 'app.ibm.com',
                        ...
                        },
                        {
                            ...
                            cluster: 'local-cluster',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/staging/deployables/staging-gbchn-redisslaveservice',
                            kind: 'deployable',
                            _rbac: 'staging_app.ibm.com_deployables',
                        ...
                        },
                        {
                            ...
                            cluster: 'local-cluster',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/staging/deployables/staging-gbchn-service',
                            kind: 'deployable',
                            _rbac: 'staging_app.ibm.com_deployables',
                        ...
                        },
                        {
                            ...
                            cluster: 'local-cluster',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/staging/deployables/staging-gbchn-redisslave',
                            kind: 'deployable',
                            _rbac: 'staging_app.ibm.com_deployables',
                    ...
                    items: [
                        {
                            ...
                            status: 'Propagated',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/guestbook2/subscriptions/guestbook2-gbapp',
                            kind: 'subscription',
    ...
    items: [
        {
            ...
            selfLink:
                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gbapp/subscriptions/cathy-gbapp-gbapp-guestbook',
            ...
            kind: 'subscription',
            label:
                'app=gbapp; chart=gbapp-0.1.0; heritage=Tiller; release=cathy-gbapp',
            type: '',
            status: 'Propagated',
            _hubClusterResource: 'true',
                    ...
                    items: [
                        {
                            ...
                            status: 'OK',
                            selfLink:
                                '/apis/clusterregistry.k8s.io/v1alpha1/namespaces/datt1/clusters/datt1',
                            name: 'datt1',
                            namespace: 'datt1',
                            nodes: 3,
                    ...
                    items: [
                        {
                            ...
                            kind: 'subscription',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/default/subscriptions/cathy-gbapp-gbapp-guestbook',
                            name: 'cathy-gbapp-gbapp-guestbook',
                            namespace: 'default',
                            ...
                            _hostingDeployable:
                                'datt1/cathy-gbapp-gbapp-guestbook-deployable-9b827',
                            _hostingSubscription: 'cathy-gbapp/cathy-gbapp-gbapp-guestbook',
                            label:
                                'app=gbapp; chart=gbapp-0.1.0; heritage=Tiller; hosting-deployable-name=cathy-gbapp-gbapp-guestbook-deployable; release=cathy-gbapp'
                        }
                    ],
                    __typename: 'SearchRelatedResult'
                },
                    ...
                    items: [
                        {
                            ...
                            kind: 'application',
                            selfLink:
                                '/apis/app.k8s.io/v1beta1/namespaces/cathy-gbapp/applications/cathy-gbapp-gbapp',
                            ...
                            label:
                                'app=gbapp; chart=gbapp-0.1.0; heritage=Tiller; release=cathy-gbapp',
                            dashboard:
                                'https://icp-console.apps.glad-polecat-icp-mst.fyre.ibm.com:443/grafana/dashboard/db/cathy-gbapp-gbapp-dashboard-via-federated-prometheus?namespace=cathy-gbapp'
                        }
                    ],
                    __typename: 'SearchRelatedResult'
                },
                    ...
                    items: [
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-service',
                            ...
                            apigroup: 'app.ibm.com',
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; heritage=Tiller; release=cathy-gb-channel'
                        },
                        {
                            created: '2019-11-18T20:14:33Z',
                            cluster: 'local-cluster',
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-redisslave',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-redismaster',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-frontend',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-redismasterservice',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gb-channel/deployables/cathy-gb-channel-gbchn-redisslaveservice',
                    ...
                    items: [
                        {
                            ...
                            kind: 'placementrule',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/cathy-gbapp/placementrules/cathy-gbapp-gbapp',
                            name: 'cathy-gbapp-gbapp',
                            namespace: 'cathy-gbapp',
                    ...
                    items: [
                        {
                            ...
                            selfLink:
                                '/api/v1/namespaces/default/pods/rbac-test-channel-gbchn-redismaster-58784b5cf-vr9dj',
                            ...
                            label:
                                'app=gbchn; pod-template-hash=58784b5cf; release=rbac-test-channel; role=master; tier=backend',
                            restarts: 0,
                            podIP: '10.1.12.129',
                        ...
                        },
                        {
                            ...
                            startedAt: '2019-11-25T20:16:02Z',
                            selfLink:
                                '/api/v1/namespaces/default/pods/rbac-test-channel-gbchn-redisslave-6c98bc5856-bc7z7',
                            ...
                            hostIP: '172.16.218.130',
                            label:
                                'app=gbchn; pod-template-hash=6c98bc5856; release=rbac-test-channel; role=slave; tier=backend',
                            restarts: 0,
                            podIP: '10.1.12.147',
                        ...
                        },
                        {
                            ...
                            startedAt: '2019-11-25T20:16:02Z',
                            selfLink:
                                '/api/v1/namespaces/default/pods/rbac-test-channel-gbchn-frontend-65c456b59f-xcf8n',
                            ...
                            label:
                                'app=gbchn; pod-template-hash=65c456b59f; release=rbac-test-channel; tier=frontend',
                            restarts: 0,
                            podIP: '10.1.188.11',
                    ...
                    items: [
                        {
                            ...
                            kind: 'secret',
                            selfLink:
                                '/api/v1/namespaces/default/secrets/default-token-hrwhb',
                    ...
                    items: [
                        {
                            ...
                            kind: 'deployment',
                            selfLink:
                                '/apis/apps/v1/namespaces/default/deployments/rbac-test-channel-gbchn-redismaster',
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-redismaster',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            apigroup: 'apps',
                            available: 1,
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; heritage=Tiller; release=rbac-test-channel',
                            ready: 1,
                            desired: 1
                        },
                        {
                            ...
                            kind: 'deployment',
                            selfLink:
                                '/apis/apps/v1/namespaces/default/deployments/rbac-test-channel-gbchn-redisslave',
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-redisslave',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            apigroup: 'apps',
                            available: 1,
                            label:
                        ...
                        },
                        {
                            ...
                            kind: 'deployment',
                            selfLink:
                                '/apis/extensions/v1beta1/namespaces/default/deployments/rbac-test-channel-gbchn-frontend',
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-frontend',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            apigroup: 'apps',
                            available: 1,
                            label:
                    ...
                    items: [
                        {
                            ...
                            kind: 'replicaset',
                            selfLink:
                                '/apis/extensions/v1beta1/namespaces/default/replicasets/rbac-test-channel-gbchn-redisslave-6c98bc5856',
                        ...
                        },
                        {
                            ...
                            kind: 'replicaset',
                            selfLink:
                                '/apis/apps/v1/namespaces/default/replicasets/rbac-test-channel-gbchn-frontend-65c456b59f',
                        ...
                        },
                        {
                            ...
                            kind: 'replicaset',
                            selfLink:
                                '/apis/extensions/v1beta1/namespaces/default/replicasets/rbac-test-channel-gbchn-redismaster-58784b5cf',
                    ...
                    items: [
                        {
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-redisslaveservice',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; heritage=Tiller; release=rbac-test-channel',
                            port: '6379/TCP',
                        ...
                        },
                        {
                            ...
                            kind: 'service',
                            selfLink:
                                '/api/v1/namespaces/default/services/rbac-test-channel-gbchn',
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-service',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; heritage=Tiller; release=rbac-test-channel',
                            port: '80:31816/TCP',
                        ...
                        },
                        {
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'rbac-test-chan/rbac-test-channel-gbchn-redismasterservice',
                            _hostingSubscription: 'default/rbac-test-app-gbapp-guestbook',
                            label:
                                'app=gbchn; chart=gbchn-0.1.0; heritage=Tiller; release=rbac-test-channel',
                            port: '6379/TCP',
                    ...
                    items: [
                        {
                            ...
                            kind: 'application',
                            selfLink:
                                '/apis/app.k8s.io/v1beta1/namespaces/rbac-test/applications/rbac-test-app-gbapp',
                            ...
                            label:
                                'app=gbapp; chart=gbapp-0.1.0; heritage=Tiller; release=rbac-test-app',
                            dashboard:
                                'https://icp-console.apps.glad-polecat-icp-mst.fyre.ibm.com:443/grafana/dashboard/db/rbac-test-app-gbapp-dashboard-via-federated-prometheus?namespace=rbac-test'
                        }
                    ],
                    __typename: 'SearchRelatedResult'
                },
                    ...
                    items: [
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-frontend',
                            name: 'rbac-test-channel-gbchn-frontend',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-redismaster',
                            name: 'rbac-test-channel-gbchn-redismaster',
                            namespace: 'rbac-test-chan',
                            _rbac: 'rbac-test-chan_app.ibm.com_deployables',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-service',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-redisslaveservice',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-redisslave',
                            name: 'rbac-test-channel-gbchn-redisslave',
                            namespace: 'rbac-test-chan',
                            _rbac: 'rbac-test-chan_app.ibm.com_deployables',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/deployables/rbac-test-channel-gbchn-redismasterservice',
                    ...
                    items: [
                        {
                            ...
                            kind: 'placementrule',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test/placementrules/rbac-test-app-gbapp',
                            name: 'rbac-test-app-gbapp',
                            namespace: 'rbac-test',
                    ...
                    items: [
                        {
                            ...
                            kind: 'channel',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/rbac-test-chan/channels/rbac-test-channel',
                    ...
                    items: [
                        {
                            ...
                            status: 'Subscribed',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/default/subscriptions/rbac-test-app-gbapp-guestbook',
                            name: 'rbac-test-app-gbapp-guestbook',
                            namespace: 'default',
                            _rbac: 'datt1_null_subscriptions',
                            ...
                            _clusterNamespace: 'datt1',
                            _hostingDeployable:
                                'datt1/rbac-test-app-gbapp-guestbook-deployable-458n4',
                            _hostingSubscription: 'rbac-test/rbac-test-app-gbapp-guestbook',
                            label:
                                'app=gbapp; chart=gbapp-0.1.0; heritage=Tiller; hosting-deployable-name=rbac-test-app-gbapp-guestbook-deployable; release=rbac-test-app'
                        }
                    ],
                    __typename: 'SearchRelatedResult'
                }
        ...
        },
        {
            ...
            selfLink:
                '/apis/app.ibm.com/v1alpha1/namespaces/actual-app/subscriptions/appmgmt-datt1',
                    ...
                    items: [
                        {
                            ...
                            label:
                                'app=appmgmt; hosting-deployable-name=appmgmt-datt1-deployable'
                        },
                        {
                            created: '2019-11-03T00:15:04Z',
                            cluster: 'local-cluster',
                    ...
                    items: [
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/actual-app/deployables/appmgmt-server-qf6vp',
                        ...
                        },
                        {
                            ...
                            status: 'Propagated',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/actual-app/deployables/appmgmt-datt1-deployable',
                        ...
                        },
                        {
                            ...
                            kind: 'deployable',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/actual-app/deployables/appmgmt-server-94dhd',
                    ...
                    items: [
                        {
                            ...
                            kind: 'channel',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/actual-app/channels/actual-app-dev',
                            name: 'actual-app-dev',
                            namespace: 'actual-app',
                    ...
                    items: [
                        {
                            ...
                            kind: 'placementrule',
                            selfLink:
                                '/apis/app.ibm.com/v1alpha1/namespaces/guestbook2/placementrules/guestbook2-gbapp',
                            name: 'guestbook2-gbapp',
                            namespace: 'guestbook2',
                            _rbac: 'guestbook2_app.ibm.com_placementrules',
