...
//TODO TODO TODO
// What do we count as a deployable?
export const getNumDeployables = data => {
  if (data && data.custom && data.custom.related) {
    if (data.custom.related instanceof Array) {
      return data.custom.related.length
    } else {
      return 0
    }
  } else {
...
export const getNumDeployments = data => {
  if (data && data.custom && data.custom.deployments) {
    if (data.custom.deployments instanceof Array) {
      return data.custom.deployments.length
    } else {
      return 0
    }
  } else {
...
export const getNumPendingDeployments = data => {
  if (data && data.custom && data.custom.deployments) {
    if (data.custom.deployments instanceof Array) {
      return data.custom.deployments.filter(obj => obj.status === 'Pending')
        .length
    } else {
      return 0
    }
...
export const getNumInProgressDeployments = data => {
  if (data && data.custom && data.custom.deployments) {
    if (data.custom.deployments instanceof Array) {
      return data.custom.deployments.filter(obj => obj.status === 'In Progress')
        .length
    } else {
      return 0
    }
...
export const getNumFailedDeployments = data => {
  if (data && data.custom && data.custom.deployments) {
    if (data.custom.deployments instanceof Array) {
      return data.custom.deployments.filter(obj => obj.status === 'Failed')
        .length
    } else {
      return 0
    }
