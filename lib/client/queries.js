...
export const HCMPolicy = gql`
  query getPolicies($name: String!, $namespace: String, $clusterName: String) {
    items: policies(name: $name, namespace: $namespace, clusterName: $clusterName) {
      cluster
      metadata {
        name
        namespace
...
export const userAccess = gql`
  query userAccess($resource: String!, $action: String!, $namespace: String){
    userAccess(resource: $resource, action: $action, namespace: $namespace)
  }
`
