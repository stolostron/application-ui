...
KUBECONFIG_HUB="cypress/config/import-kubeconfig/hub-kubeconfig"
KUBECONFIG_SPOKE="cypress/config/import-kubeconfig/kubeconfig"
...
argocd app create guestbook-argo-app --repo https://github.com/argoproj/argocd-example-apps.git --path guestbook --dest-server $SPOKE_CLUSTER_SERVER --dest-namespace default
argocd app sync guestbook-argo-app
