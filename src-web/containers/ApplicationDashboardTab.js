...
export class ApplicationDashboardTab extends React.Component {
  ...
  render() {
    return (
      <div className='applicationOverviewTab'>
        <ApplicationDetailsContainer />
        {/*<ApplicationTopologyContainer />*/}
      </div>
    )
  }
}

ApplicationDashboardTab.propTypes = {
  location: PropTypes.object,
  secondaryHeaderProps: PropTypes.object,
  updateSecondaryHeader: PropTypes.func,
}

ApplicationDashboardTab.contextTypes = {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ApplicationDashboardTab))
