...
export const HCMClusterList = gql`
  query getClusters($filter: Filter) {
    items: clusters(filter: $filter) {
      ClusterName
      ClusterEndpoint
      Labels
      Status
...
export const createDashboard = gql`
  mutation createDashboard($appName: String!) {
    createDashboard(appName: $appName)
  }
`
...
export const HCMPodList = gql`
  query getPods($filter: Filter) {
    items: pods(filter: $filter) {
      Namespace
      PodName
      name
      cluster
...
export const HCMReleaseList = gql`
  query getReleases($filter: Filter) {
    items: releases(filter: $filter) {
      ChartName
      ChartVersion
      HelmName
      Namespace
