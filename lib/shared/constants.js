...
module.exports.DOC_PATH_BASE = 'https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.0/html/manage_applications/managing-applications#'

module.exports.DOC_LINKS = {
  TERMINOLOGY: `${
    module.exports.DOC_PATH_BASE
  }application-model-and-definitions`,
  APPLICATIONS: `${module.exports.DOC_PATH_BASE}managing-application-resources`,
  SUBSCRIPTIONS: `${
    module.exports.DOC_PATH_BASE
