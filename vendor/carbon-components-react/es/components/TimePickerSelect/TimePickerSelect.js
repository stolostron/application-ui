...
function (_Component) {
  ...
  _createClass(TimePickerSelect, [{
    ...
    value: function render() {
      ...
      var selectClasses = classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--select"), true), _defineProperty(_classNames, "".concat(prefix, "--time-picker__select"), true), _defineProperty(_classNames, "".concat(prefix, "--select--inline"), true), _defineProperty(_classNames, className, className), _classNames));
