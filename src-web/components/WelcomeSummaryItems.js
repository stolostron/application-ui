...
export const SetupCLI = ({ locale }) => (
  <div className="setup-cli-container">
    <a href="/console/tools/cli?useNav=mcm-ui" className="cli-link">
      ...
      <img
        src={`${config.contextPath}/graphics/arrow.svg`}
        alt={msgs.get('cli.alt', locale)}
      />
    </a>
  </div>
);
  ...
  <li className="bx--list__item">
    ...
    <div className="content">
      ...
      <Icon
        name="launch--glyph"
        fill="#d1d7f4"
        description={msgs.get('svg.description.launch', locale)}
      />
      <a
      ...
      >
        {msgs.get('welcome.box.one.bullet.one.link', locale)}
      </a>
    </div>
...
export const Catalog = ({ locale, showHorizontalRule }) => (
  <li className="bx--list__item">
    ...
    <div className="content">
      <a href="/catalog" className="bx--link">
        {msgs.get('welcome.box.one.bullet.two.link.catalog', locale)}
      </a>
      <span className="divider">|</span>
      <a href="/catalog/instances" className="bx--link">
        {msgs.get('welcome.box.one.bullet.two.link.helm', locale)}
      </a>
    </div>
    {showHorizontalRule && <div className="horizontal-rule" />}
  </li>
...
export const Clusters = ({ locale, hideVerticalRule }) => (
  <li
    className={`bx--list__item${hideVerticalRule ? ' no-vertical-rule' : ''}`}
  >
    ...
    <div className="content">
      ...
      />
      <a
        href="https://www.ibm.com/support/knowledgecenter/SSBS6K_3.2.0/mcm/manage_cluster/add_remove_cluster.html"
        target="_cluster"
        className="bx--link"
        aria-describedby="launchWindow"
      >
        {msgs.get('welcome.box.two.bullet.one.link', locale)}
      </a>
    </div>
  </li>
);
...
export const HelmRepo = ({ locale, hideVerticalRule }) => (
  ...
  >
    ...
    <div className="content">
      <a href="/catalog/repositories" className="bx--link">
        {msgs.get('welcome.box.two.bullet.two.link', locale)}
      </a>
    </div>
  </li>
);
...
export const Compliance = ({ locale, hideVerticalRule }) => (
  ...
  >
    ...
    <div className="content">
      <a href="/multicloud/policies" className="bx--link">
        {msgs.get('welcome.box.two.bullet.four.link', locale)}
      </a>
    </div>
  </li>
);
...
export const Users = ({ locale, hideVerticalRule }) => (
  ...
  >
    ...
    <div className="content">
      <a href="/console/manage/identity-access" className="bx--link">
        {msgs.get('welcome.box.two.bullet.five.link', locale)}
      </a>
    </div>
  </li>
);
