...
export function getUpdates(previousParsed, currentParsed) {
  ...
  Object.keys(currentParsed).some(key=>{
    ...
    case 'PlacementPolicy':
      cantUpdate = getPlacementPolicyUpdates(previousParsed, currentParsed[key], updates)
      break
...
function getPlacementPolicyUpdates({placementPolicies}, currentParsed, updates) {
