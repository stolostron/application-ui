    ...
    related: [
      ...
      },
      {
        items: [{
          ...
          name: "mortgage-app-subscription",
          namespace: "default",
          selfLink: "/apis/apps.open-cluster-management.io/v1/namespaces/default/subscriptions/mortgage-app-subscription",
          status: "Propagated",
        ...
        items: [
          {
            ...
            namespace: "default",
            selfLink: "/apis/apps.open-cluster-management.io/v1/namespaces/default/deployables/mortgage-app-subscription-mortgage-mortgage-app-svc-service",
            _hubClusterResource: "true",
          ...
          },
          {
            ...
            namespace: "default",
            selfLink: "/apis/apps.open-cluster-management.io/v1/namespaces/default/deployables/mortgage-app-subscription-mortgage-mortgage-app-deploy-deployment",
            _hubClusterResource: "true",
            _rbac: "default_apps.open-cluster-management.io_deployables",
      ...
      },
      {
        items: [{
          ...
          namespace: "default",
          selfLink: "/apis/apps.open-cluster-management.io/v1/namespaces/default/placementrules/mortgage-app-placement",
          _hubClusterResource: "true",
  ...
  links: [
    {
      ...
      specs: {isDesign: true},
      to: {uid: "member--subscription--default--mortgage-app-subscription", __typename: "Resource"},
      type: "",
      __typename: "Relationship"
    },
    {
      from: {uid: "member--subscription--default--mortgage-app-subscription", __typename: "Resource"},
      specs: {isDesign: true},
      to: {uid: "member--rules--default--mortgage-app-placement--0", __typename: "Resource"},
      type: "uses",
      __typename: "Relationship"
    },
    {
    ...
    },
    {
      ...
      specs: null,
      to: {uid: "member--member--deployable--member--clusters--fxia…rtgage-app-svc-service--service--mortgage-app-svc", __typename: "Resource"},
      type: "",
      __typename: "Relationship"
    },
    {
      from: {uid: "member--clusters--fxiang", __typename: "Resource"},
      specs: null,
      to: {uid: "member--member--deployable--member--clusters--fxia…eploy-deployment--deployment--mortgage-app-deploy", __typename: "Resource"},
      type: "",
      __typename: "Relationship"
    },
    {
      from: {uid: "member--member--deployable--member--clusters--fxia…eploy-deployment--deployment--mortgage-app-deploy", __typename: "Resource"},
      specs: null,
      to: {uid: "member--member--deployable--member--clusters--fxiang--replicaset--mortgage-app-deploy", __typename: "Resource"},
      type: "",
      __typename: "Relationship"
    }
  ],
  ...
  nodes: [
    ...
    },
    {
      ...
      specs: {
        ...
        raw: {
          ...
          status: {lastUpdateTime: "2020-08-15T09:11:11Z", phase: "Propagated"}
        },
        row: 18
      },
      topology: null,
    ...
    },
    {
      ...
      specs: {
        isDesign: true,
        pulse: "green",
        raw: {apiVersion: "apps.open-cluster-management.io/v1", kind: "PlacementRule"},
        row: 34
      },
      topology: null,
      type: "rules",
    ...
    },
    {
      ...
      specs: {
        cluster: {
          ...
          metadata: {creationTimestamp: "2020-08-13T18:17:34Z", finalizers: Array(5), generation: 1, name: "fxiang"},
          rawCluster: {apiVersion: "cluster.open-cluster-management.io/v1", kind: "ManagedCluster"},
          rawStatus: {apiVersion: "internal.open-cluster-management.io/v1beta1", kind: "ManagedClusterInfo"},
          status: "ok"
        },
        clusterNames: ["fxiang"],
        clusters: [{
    ...
    },
    {
      ...
      specs: {
        deployStatuses: [],
        isDesign: false,
        parent: {parentId: "member--clusters--fxiang", parentName: "fxiang", parentType: "cluster"},
        pulse: "orange",
    ...
    },
    {
      ...
      specs: {
        isDesign: false,
        parent: {parentId: "member--member--deployable--member--clusters--fxia…eploy-deployment--deployment--mortgage-app-deploy", parentName: "mortgage-app-deploy", parentType: "deployment"},
        pulse: "orange",
        raw: {kind: "replicaset"},
        row: 93
      },
