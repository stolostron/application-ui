...
`
export const HCMSecretList = gql`
  query applicationSecrets {
    items: applicationSecrets {
      metadata {
        name
      }
    }
...
export const HCMSecret = gql`
  query applicationSecrets($namespace: String!) {
    items: applicationSecrets(namespace: $namespace) {
      metadata {
        name
      }
    }
