    ...
    return (
      <div className={'bx--modal-content-body'}>
        ...
        <div className={'bx--modal-content-body-row'}>
          <div className={'body-pill'}>
            <p className={'body-pill-label'}>Type</p>
          </div>
          <p>{typeText}</p>
        </div>
        <div className={'bx--modal-content-body-row'}>
          <div className={'body-pill'}>
            <p className={'body-pill-label'}>Show</p>
          </div>
          <p>{showText}</p>
        </div>
      </div>
            ...
            >
              <div>
                <div className={'bx--modal-content-header'}>
                  <div className={'bx--modal-content-header-content'}>
                    <div className={'bx--modal-content-header-main'}>
                      {msgs.get(
                        'modal.query.info.heading',
                        this.context.locale
                      )}
                    </div>
                    <div className={'bx--modal-content-header-subtext'}>
                      {msgs.get(
                        'modal.query.info.heading.subtext',
                        this.context.locale
                      )}
                    </div>
                  </div>
                  <div className="related-resource-tile">
                    <img
                      ...
                      src={`${config.contextPath}/graphics/SearchGuideIcon.svg`}
                      alt={''}
                    />
                  </div>
                </div>
                {this.renderModalBodySection(
                  msgs.get(
                    'modal.query.info.keyword.desc',
                    this.context.locale
                  ),
                  'IBM',
                  msgs.get(
                    'modal.query.info.keyword.example',
                    this.context.locale
                  )
                )}
                {this.renderModalBodySection(
                  ...
                  msgs.get(
                    'modal.query.info.filter.example',
                    this.context.locale
                  )
                )}
                <div className={'bx--modal-content-body'}>
                  ...
                  <UnorderedList>
                    <ListItem>
                      {msgs.get(
                        'modal.query.info.special.note1',
                        this.context.locale
                      )}
                    </ListItem>
                    <ListItem>
                      {msgs.get(
                        'modal.query.info.special.note2',
                        this.context.locale
                      )}
                    </ListItem>
                  </UnorderedList>
